...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/lightgallery-bundle.css') }}">
    <style>
        /* Base styles */
        body {
            margin: 0;
...
<body>
    ...
    <div class="topnav">
        <div class="sidenav">
            <a href="{{route("home")}}"><h1>SCBD Portal</h1></a>
            <div class="middlenav">
                <div class="menu-items" id="menuItems">
                    <a href="{{route("home")}}">Home</a>
                    <div class="dropdown">
                        <a href="#" class="dropbtn">Forms & Templates <i class="fas fa-caret-down"></i></a>
                        <div class="dropdown-content">
                            <a href="{{ route('templates.category', ['category' => 'all']) }}">All Forms</a>
                            <a href="{{ route('templates.category', ['category' => 'communication']) }}">Communications</a>
                            <a href="{{ route('templates.category', ['category' => 'manual']) }}">BA Manual</a>
                    ...
                    <a href="{{route("mediaLibrary")}}">Media Library</a>
                    <a href="{{route("staffList")}}">Staff List</a>
...
<!-- LightGallery Scripts -->
 <script>
    document.addEventListener("DOMContentLoaded", function() {
        // Initialize LightGallery for all groups
