        ...
        <tr>
            <td align="center">
                <table role="presentation" width="680" cellspacing="0" cellpadding="0" style="max-width:680px;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                    <tr>
                        <!-- <td style="background:#0b7285;color:#ffffff;padding:16px 24px;">
                            <h2 style="margin:0;font-size:20px;">Request for Quotation (RFQ)</h2>
                        </td> -->
                    </tr>
                    <tr>
                        <td style="padding:20px 24px;">
                            <p style="margin:0 0 12px;">Dear Vendor,</p>
                            <p style="margin:0 0 12px;">Greetings from Swisscontact Bangladesh!</p>
                            <p style="margin:0 0 16px;">You are invited to submit your quotation for the following procurement requisition.</p>
                            ...
                            <!-- <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin-bottom:16px;">
                                ...
                                <tr>
                                    <td style="padding:8px 10px;border:1px solid #e5e7eb;background:#f9fafb;"><strong>Expected Delivery</strong></td>
                                    <td style="padding:8px 10px;border:1px solid #e5e7eb;">{{ optional($requisition->expected_delivery_date)->format('d M Y') }}</td>
                                </tr>
                            </table> -->
